...
import logo from '../../../static/logoTurkmall.png';
		...
		/>
			...
			>
				...
				<ul className="navigation-menu-main">
					...
					{/*</li>*/}
					{/*<li>*/}
					{/*	<Link to={ROUTE.SHOP}>МАГАЗИН</Link>*/}
					{/*</li>*/}
					<li>
						<Link to={ROUTE.WOMAN}>ЖЕНЩИНА</Link>
					</li>
					<li>
						<Link to={ROUTE.MAN}>МУЖЧИНА</Link>
					</li>
					<li>
						<Link to={ROUTE.CHILD}>РЕБЁНОК</Link>
					</li>
					{/*<li>*/}
					{/*	<Link to={ROUTE.BABY}>МАЛЫШ</Link>*/}
					{/*</li>*/}
				</ul>
