...
const Basket = (props) => {
	...
	return (
		<Boundary>
			...
			>
				<p className="text-center">Вы должны войти в систему, чтобы продолжить оформление заказа</p>
				<br />
			...
			<div className="basket">
				<div className="basket-list">
					...
					{basket.length <= 0 && (
						<div className="basket-empty">
							<h5 className="basket-empty-msg">Ваша корзина пуста</h5>
						</div>
					)}
				...
				<div className="basket-checkout">
					<div className="basket-total">
						<p className="basket-total-title">Итоговая сумма:</p>
